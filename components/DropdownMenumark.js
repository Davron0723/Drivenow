  ...
  return (
    <div className="w-full">
      ...
      <select
        ...
        className="block w-full bg-[#31313180] border border-[#31313180] rounded-md text-sm font-semibold pr-80 py-2">
...
export default DropdownMenumark;